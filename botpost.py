...
resp = api.send_message('Me venda o tênis Nike Dunk panda em um texto de um parágrafo de 3 linhas sem falar da sua sola de EVA')

cl = Client()
cl.login("splashsneakers.inc", "LUCIANe101@#")

media = cl.album_upload(
    List["app/image1.jpg", "app/image2.jpg", "app/image3.jpg"],
    resp['message'],
    extra_data={
